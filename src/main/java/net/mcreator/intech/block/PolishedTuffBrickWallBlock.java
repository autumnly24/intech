...
public class PolishedTuffBrickWallBlock extends WallBlock {
	public PolishedTuffBrickWallBlock() {
		super(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM)
				...
				.strength(2f, 6f).requiresCorrectToolForDrops().dynamicShape().forceSolidOn());
	}
