...
@Mod("intech")
public class IntechMod {
	public static final Logger LOGGER = LogManager.getLogger(IntechMod.class);
	public static final String MODID = "intech";
